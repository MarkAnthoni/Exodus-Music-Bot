...
module.exports = {
    ...
    options: [
        {
            name: "search",
            description: "Búsqueda de letras de canciones concretas.",
    ...
    run: async (client, interaction, player) => {
        ...
        try {
            ...
            lyricEmbed.setDescription(`\`❌\` | No se ha encontrado ninguna letra!`);
