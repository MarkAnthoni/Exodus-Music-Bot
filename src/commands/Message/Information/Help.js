    ...
    run: async (client, message, args) => {
        ...
        if (!args[0]) {
            ...
            const embed = new EmbedBuilder()
                ...
                .setImage(imageUrl)
                .setDescription(
                    `Hola **${message.author}**, Soy **${client.user}**. Un Bot de Música de Discord de Alta Calidad. Soporta Spotify, SoundCloud, Apple Music y otros. Averigüe lo que puedo hacer usando la selección de menú a continuación.`,
                )
                .setFooter({
                    text: `© ${client.user.username} | Total de comandos: ${client.slashCommands.size}`,
            ...
            const row = new ActionRowBuilder().addComponents([
                new StringSelectMenuBuilder()
                    ...
                    .setPlaceholder(`Comandos de la categoría de menú Select`)
                    .setMaxValues(1)
                    .setMinValues(1)
                    .setOptions(
